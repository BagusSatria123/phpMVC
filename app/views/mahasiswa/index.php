            ...
            <ul class="list-group">
                <?php foreach ($data['mhs'] as $mhs) : ?>
                    <li class="list-group-item"><?= $mhs['nama']; ?>
                        ...
                        <!-- diberi javascript ditaruh di folder public/js -->
                        ...
                        <a href="<?= BASEURL; ?>/mahasiswa/detail/<?= $mhs['id']; ?>" class="badge badge-primary float-right ml-2">Detail</a></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
...
<!-- Modal (harus dibawah karna hidden) -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
                    <!-- bikin elemet form baru yaitu input supaya id dikirim -->
